                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <a href="#">
                            <div class="item">
                                <div class="image">
                                    <img src="{{ asset('assets/images/featured-01.png') }}" alt=""
                    ...
                    <div class="col-lg-3 col-md-6">
                        <a href="#">
                            <div class="item">
                                <div class="image">
                                    <img src="{{ asset('assets/images/featured-02.png') }}" alt=""
                                        style="max-width: 44px;">
                                </div>
                                <h4>User More</h4>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <a href="#">
                            <div class="item">
                                <div class="image">
                                    <img src="{{ asset('assets/images/featured-03.png') }}" alt=""
                                        style="max-width: 44px;">
                                </div>
                                <h4>Reply Ready</h4>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <a href="#">
                            <div class="item">
                                <div class="image">
                                    <img src="{{ asset('assets/images/featured-04.png') }}" alt=""
                                        style="max-width: 44px;">
                                </div>
                                <h4>Easy Layout</h4>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6">
                        <div class="item">
                            ...
                            <div class="down-content">
                                <span class="category">ALL CAR</span>
                                <h4>Cars</h4>
                                <a href="{{ route('category.cars') }}">Explore</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-6 col-sm-6">
                        <div class="item">
                            ...
                            <div class="down-content">
                                <span class="category">ALL BICY</span>
                                <h4>Bicyles</h4>
                                <a href="{{ route('category.bicyles') }}">Explore</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-6 col-sm-6">
